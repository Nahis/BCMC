...
<body>
    <form id="form1" runat="server" onsubmit="return (typeof submitted == 'undefined') ? (submitted = true) : !submitted" >
    ...
    <script type="text/javascript">
		...
		function setPosInline(id, id2, adjustment) {
			el = document.getElementById(id);
			if (null == el)
				return;
			...
			if (typeof adjustment == 'undefined')
				adjustment = 0;
			setPos(id2, r1.left+r1.width, r1.top-rParent.top-1+ adjustment);
		}
		function lineUpFromOffset(idList, offset) {
			for (var i = 0; i < idList.length; i++) {
				if (0 == i)
					setPos(idList[i], offset);
				else
		...
		function positionChanged() {
			...
			offset = offset - 3 - document.getElementById('RemoveActualDayAbove').getBoundingClientRect().width * 2 / 2; /*width of both buttons */

			lineUpFromOffset(['RemoveActualDayAbove', 'AddActualDayAbove', 'TopActualDaysHelpText'], offset);
			lineUpFromOffset(['RemoveActualDayBelow', 'AddActualDayBelow', 'BottomActualDaysHelpText'], offset);
	...
	<div class="centreInMarginsDebug">
		...
		<div>
			...
			<Columns>
				...
				<asp:BoundField DataField="Day Number" HeaderText="Day Number" 
								...
								ItemStyle-Font-Size="11px" ItemStyle-CssClass="gridcell"/>
				...
				<asp:TemplateField HeaderText="Original Block">
					...
					<HeaderStyle CssClass="cell" /></asp:TemplateField>
				...
				<asp:BoundField DataField="Room Guid" HeaderText="Room Guid" 
								ItemStyle-Width="15%" ItemStyle-Font-Size="11px"
								HeaderStyle-CssClass="cell"  >
					<ItemStyle 
		...
		<div class="buttons">
			...
			<asp:Button id="btnAddActualDayBelow" runat="server" 
						style="display:none" 
						onclick="btnAddActualDayBelow_OnClick" 
						/>
			<script>
				function DivClicked(sender, parm) {
					...
					return;
					//return;
					var btnHidden = document.getElementById('<%= btnAddActualDayBelow.ClientID %>');
					...
					if (btnHidden != null) {
						//btnHidden.click();
						__doPostBack('<%=btnAddActualDayBelow.ClientID %>', sender);
					}
				}
				...
				<a href="" id="Grey" runat="server" onserverclick='btnAddActualDayBelow_OnClick'>Test Text</a></div>
			...
			<div id="mySB">
				...
				<asp:Button ID="ButtonSave" runat="server" name="ButtonSave"
							...
							ToolTip="Save" 
							/>
				<span id="mySB-lhs" class="crmStyle" >
					<span >Arrival/Departure: <span class="fld-value">2014-07-02 - 2014-07-06</span></span>
